    ...
    <div class="page-wrapper">
        ...
        <header class="main-header header-style-one">
                ...
                <div class="auto-container">
                    <div class="clearfix">
                        ...
                        <div class="top-right pull-right">
                            ...
                            <!-- Social Nav -->
                            <ul class="social-nav">
                                <li class="facebook"><a href="{{Helpers::findFirst('about')->facebook}}"><span
                                            class="fa fa-facebook-f"></span></a></li>
                                <li class="twitter"><a href="{{Helpers::findFirst('about')->twitter}}"><span
                                            class="fa fa-twitter"></span></a></li>
                                <li class="google"><a href="{{Helpers::findFirst('about')->google}}"><span
                                            class="fa fa-google-plus"></span></a></li>
                                <li class="linked"><a href="{{Helpers::findFirst('about')->linkedin}}"><span
                        ...
                        <div class="pull-right upper-right clearfix row">
                            <div class="pull-left logo-box col-sm-3">
                                <div class="logo"><a href="{{ asset('/') }}"><img
                                            src="{{ asset('/frontEnd') }}/images/logo.png" alt="" title=""></a></div>
                            </div>
                            <!--Info Box-->
                                    ...
                                    <div class="mega-menu-bar row clearfix">
                                        <div class="column col-lg-4 col-md-4 col-sm-12">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{ asset('frontEnd') }}/testimonial.html">Testimonial</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="column col-lg-4 col-md-4 col-sm-12">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{ asset('frontEnd') }}/services-single.html">Services
                                                        Single</a></li>
                                                <li><a href="{{ asset('frontEnd') }}/comming-soon.html">Coming Soon</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="column col-lg-4 col-md-4 col-sm-12">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{ asset('frontEnd') }}/blog-sidebar.html">Blog Sidebar</a>
                                                </li>
                                                <li><a href="{{ asset('frontEnd') }}/news-detail.html">Blog Details</a>
                                                </li>
                                                <li><a href="{{ asset('frontEnd') }}/error-page.html">Error Page</a>
                                                </li>
                                            </ul>
                                        </div>
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="nav-logo"><a href="{{ asset('frontEnd') }}/index.html"><img src="images/logo.png" alt=""
                                title=""></a></div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="footer-column col-lg-4 col-md-6 col-sm-12">
                            <div class="footer-widget logo-widget">
                                <div class="logo">
                                    <a href="{{ asset('fronted') }}/index.html"><img src="images/footer-logo.png"
                                            alt="" /></a>
                                </div>
                                <div class="text">
                                ...
                                <ul class="contact-link">
                                    <li><span class="icon flaticon-clock"></span>
                                        {{Helpers::findFirst('contact')->start_time}}
                                        -{{Helpers::findFirst('contact')->end_time}}, Close:
                                        {{Helpers::findFirst('contact')->off_day}}</li>
                                    <li><span class="icon flaticon-home-page"></span>
                        ...
                        <div class="footer-column col-lg-4 col-md-6 col-sm-12">
                            <div class="footer-widget news-widget">
                                ...
                                <div class="widget-content">
                                    <div class="post">
                                        <div class="thumb"><a href="{{ asset('fronted') }}/news-detail.html"><img
                                                    src="images/resource/post-thumb-1.jpg" alt=""></a></div>
                                        <h5><a
                                                href="{{url('/blog_single',['slug'=>$item->slug])}}">{{$item->header}}</a>
                                        </h5>
