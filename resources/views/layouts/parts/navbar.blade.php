      ...
      <div class="navbar-header" data-logobg="skin5">
          ...
          <a class="navbar-brand" href="{{ asset('/') }}">
              ...
              <b class="logo-icon p-l-10">
                  ...
                  <img src="{{(Helpers::schoolInfo()->logo1 != null) ? Storage::url(Helpers::schoolInfo()->logo1)  :  asset('/').'assets/images/logo-icon.png'}}" alt="homepage" class="light-logo" style="height: 44px;width: 44px" />
