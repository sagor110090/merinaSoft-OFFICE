<div class="form-group {{ $errors->has('header') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="header" type="text" id="header" value="{{ isset($about->header) ? $about->header : ''}}" required>
    {!! $errors->first('header', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('short_description') ? 'has-error' : ''}}">
    <label for="short_description" class="control-label">{{ 'Short Description' }}</label>
    <textarea name="short_description"  class="form-control" cols="30" rows="10" required>
...
<div class="form-group {{ $errors->has('facebook') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="facebook" type="text" id="facebook" value="{{ isset($about->facebook) ? $about->facebook : ''}}" required>
    {!! $errors->first('facebook', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('twitter') ? 'has-error' : ''}}">
    <label for="twitter" class="control-label">{{ 'Twitter Link' }}</label>
    <input class="form-control" name="twitter" type="text" id="twitter" value="{{ isset($about->twitter) ? $about->twitter : ''}}" required>
    {!! $errors->first('twitter', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('linkedin') ? 'has-error' : ''}}">
    <label for="linkedin" class="control-label">{{ 'Linkedin Link' }}</label>
    <input class="form-control" name="linkedin" type="text" id="linkedin" value="{{ isset($about->linkedin) ? $about->linkedin : ''}}" required>
    {!! $errors->first('linkedin', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('instagram') ? 'has-error' : ''}}">
    <label for="instagram" class="control-label">{{ 'Instagram Link' }}</label>
    <input class="form-control" name="instagram" type="text" id="instagram" value="{{ isset($about->instagram) ? $about->instagram : ''}}" required>
    {!! $errors->first('instagram', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('youtube') ? 'has-error' : ''}}">
    <label for="youtube" class="control-label">{{ 'Youtubbe Link' }}</label>
    <input class="form-control" name="youtube" type="text" id="youtube" value="{{ isset($about->youtube) ? $about->youtube : ''}}" required>
...
<div class="form-group {{ $errors->has('google') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="google" type="text" id="google" value="{{ isset($about->google) ? $about->google : ''}}" required>
    {!! $errors->first('google', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('skype') ? 'has-error' : ''}}">
    <label for="skype" class="control-label">{{ 'Skype Link' }}</label>
    <input class="form-control" name="skype" type="text" id="skype" value="{{ isset($about->skype) ? $about->skype : ''}}" required>
...
<div class="form-group {{ $errors->has('image') ? 'has-error' : ''}}">
    <div class="avatar-upload">
        ...
        <div id="imagePreview" style="background-image: url({{(isset($about->image) ? Storage::url($about->image) : 'https://4.bp.blogspot.com/_j-IldstRiaI/TS7AcMnzI0I/AAAAAAAAAFc/5548Yg80r30/w1200-h630-p-k-no-nu/110075pp.jpg')}});">
            </div>
        </div>
    </div>
</div>
