<div class="form-group {{ $errors->has('header') ? 'has-error' : ''}}">
    <label for="header" class="control-label">{{ 'project Header' }}</label>
    <input class="form-control" name="header" type="text" id="header" value="{{ isset($project->header) ? $project->header : ''}}" required>
...
{{-- <div class="form-group {{ $errors->has('category_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="category_id" type="number" id="category_id" value="{{ isset($project->category_id) ? $project->category_id : ''}}" required>
...
<div class="form-group {{ $errors->has('client_name') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="client_name" type="text" id="client_name" value="{{ isset($project->client_name) ? $project->client_name : ''}}" required>
    {!! $errors->first('client_name', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('location') ? 'has-error' : ''}}">
    <label for="location" class="control-label">{{ 'Location' }}</label>
    <input class="form-control" name="location" type="text" id="location" value="{{ isset($project->location) ? $project->location : ''}}" required>
    {!! $errors->first('location', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('year') ? 'has-error' : ''}}">
    <label for="year" class="control-label">{{ 'Year' }}</label>
    <input class="form-control" name="year" type="text" id="year" value="{{ isset($project->year) ? $project->year : ''}}" required>
    {!! $errors->first('year', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('value') ? 'has-error' : ''}}">
    <label for="value" class="control-label">{{ 'Value' }}</label>
    <input class="form-control" name="value" type="text" id="value" value="{{ isset($project->value) ? $project->value : ''}}" required>
    {!! $errors->first('year', '<p class="help-block">:message</p>') !!}
</div>
